...
public class ListaHotel extends JPanel implements ActionListener
{
	...
	public ListaHotel(FondoHotel ventanaPrincipal)
	{
		//Valores Del Panel
		setLayout(null);
		...
		lbTitulo = new JLabel("LISTA DE PERSONAS HOSPEDADAS ACTIVAS");
	...
	public void ActualizarLista()
	{
		...
		{
			if(h.getEstado().equals(EstadoHospedaje.APARTADO) || h.getEstado().equals(EstadoHospedaje.HOSPEDADO))
			{
